...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      provider: () => new HDWalletProvider(mnemonic, `https://rinkeby.infura.io/ws/v3/97a995af8b054a769d69779b3e022a04`),
    ...
    klaytn_testnet: {
      provider: () => new HDWalletProvider(fs.readFileSync(".secret_klaytn").toString().trim(), "https://api.baobab.klaytn.net:8651"),
